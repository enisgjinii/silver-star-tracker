...
function requireWindows() {
  ...
  const addon = /* @__PURE__ */ requireWindowsBinding();
...
var hasRequiredActiveWin;
function requireActiveWin() {
  if (hasRequiredActiveWin) return activeWin$1.exports;
  hasRequiredActiveWin = 1;
  activeWin$1.exports = (options) => {
    if (process.platform === "darwin") {
      return /* @__PURE__ */ requireMacos()(options);
    }
    if (process.platform === "linux") {
      return /* @__PURE__ */ requireLinux()(options);
    }
    if (process.platform === "win32") {
      return /* @__PURE__ */ requireWindows()(options);
    }
    return Promise.reject(new Error("macOS, Linux, and Windows only"));
  };
  activeWin$1.exports.sync = (options) => {
    if (process.platform === "darwin") {
      return /* @__PURE__ */ requireMacos().sync(options);
    }
    if (process.platform === "linux") {
      return /* @__PURE__ */ requireLinux().sync(options);
    }
    if (process.platform === "win32") {
      return /* @__PURE__ */ requireWindows().sync(options);
    }
    throw new Error("macOS, Linux, and Windows only");
  };
  activeWin$1.exports.getOpenWindows = (options) => {
    if (process.platform === "darwin") {
      return /* @__PURE__ */ requireMacos().getOpenWindows(options);
    }
    if (process.platform === "linux") {
      return /* @__PURE__ */ requireLinux().getOpenWindows(options);
    }
    if (process.platform === "win32") {
      return /* @__PURE__ */ requireWindows().getOpenWindows(options);
    }
    return Promise.reject(new Error("macOS, Linux, and Windows only"));
  };
  activeWin$1.exports.getOpenWindowsSync = (options) => {
    if (process.platform === "darwin") {
      return /* @__PURE__ */ requireMacos().getOpenWindowsSync(options);
    }
    if (process.platform === "linux") {
      return /* @__PURE__ */ requireLinux().getOpenWindowsSync(options);
    }
    if (process.platform === "win32") {
      return /* @__PURE__ */ requireWindows().getOpenWindowsSync(options);
    }
    throw new Error("macOS, Linux, and Windows only");
  };
  return activeWin$1.exports;
}
var activeWinExports = /* @__PURE__ */ requireActiveWin();
const activeWin = /* @__PURE__ */ getDefaultExportFromCjs(activeWinExports);
async function getActiveWindow() {
  try {
    const result = await activeWin();
    return result;
  } catch (error2) {
    console.error("Error getting active window:", error2);
    return null;
  }
}
export {
